...
- [ ] can we also make the buttons all the same size (maximum width the same as whitepaper)
...
- [ ] background blur transition is lost on mobiles; why is this? see mesh.xy for example of it working.
- [ ] we want the footer to scroll snap everywhere on the site, currently it does not work on the about page or team pages.
- [ ] increase size of team page team member images on desktop and align left "for reference see https://www.mesh.xyz/team for sizing and alignment", Note that we dont want to align left on mobile, there should be 2 columns.
...
- [x] can we please replace the first image content box on the home page, and embed this video and auto play? https://youtu.be/4UNDYDzkK6o
